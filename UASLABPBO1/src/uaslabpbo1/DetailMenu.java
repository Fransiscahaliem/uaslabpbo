...
public class DetailMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tf_noPesanan.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
        ...
        tf_nama.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
        ...
        tf_waktu.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
        getContentPane().add(tf_waktu, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 340, 320, 40));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 420, 670, 270));

        btn_addQueue.setBackground(new java.awt.Color(253, 206, 4));
        btn_addQueue.setFont(new java.awt.Font("Segoe Print", 1, 18)); // NOI18N
        btn_addQueue.setForeground(new java.awt.Color(195, 31, 38));
        ...
        getContentPane().add(btn_addQueue, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 730, 170, 50));
        ...
        tf_totalHarga.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
        ...
        tf_kembalian.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
        ...
        tf_uangDiberikan.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
        ...
        btn_menu.setBackground(new java.awt.Color(195, 31, 38));
        ...
        getContentPane().add(btn_menu, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 730, 150, 50));

        btn_lihatAntri.setBackground(new java.awt.Color(195, 31, 38));
        btn_lihatAntri.setFont(new java.awt.Font("Segoe Print", 1, 18)); // NOI18N
        btn_lihatAntri.setForeground(new java.awt.Color(253, 206, 4));
        ...
        getContentPane().add(btn_lihatAntri, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 730, 180, 50));

        tf_idTransaksi.setEditable(false);
        tf_idTransaksi.setFont(new java.awt.Font("Segoe Script", 1, 18)); // NOI18N
        tf_idTransaksi.setBorder(new javax.swing.border.MatteBorder(null));
        getContentPane().add(tf_idTransaksi, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 230, 150, 40));
